        ...
        <div class="alert bg-light p-4 col-8 mx-auto shadow">
            <form action="/categoria/update" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('catNombre', $Categorias->catNombre) }}" name="catNombre" class="form-control" id="catNombre">
                </div>
                ...
                <a href="/categorias" class="btn btn-outline-secondary">Volver a panel de categorías</a>
            </form>
        </div>
