        ...
        <div class="alert p-4 col-8 mx-auto shadow">
            <form action="/producto/store" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="text" name="prdNombre" value="{{ old('prdNombre') }}" class="form-control" id="prdNombre">
                </div>
                ...
                <div class="input-group mb-4">
                    ...
                    <input type="number" name="prdPrecio" value="{{ old('prdPrecio') }}" class="form-control" id="prdPrecio" step="0.01">
                </div>
